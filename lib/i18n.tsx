...
const DICT: Record<string, string> = {
    ...
    "epub / pdf / markdown 全站内阅读 · AI 陪读": "Read epub / pdf / markdown in-app · AI companion",
    "翻开 →": "Open →",
    "暂无藏书": "No books yet",
    "去后台导入": "Import in console",
    "没有书架访问权限——请先登录（或找站长开通图书权限）。": "No library access — please sign in (or ask the owner to grant book access).",
    "书架加载失败，请稍后重试。": "Failed to load library, please retry.",
    "继续阅读 →": "Keep reading →",
    "首页探索": "Explore",
    "文件": "Files",
    "分类": "Browse",
